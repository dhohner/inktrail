...
var modeOptions = []modeOption{
	{label: "Analyze staged files", description: "Review exactly what is staged for your next commit."},
	{label: "Analyze a commit", description: "Inspect one commit against its parent.", placeholder: "HEAD", help: "commit ref, e.g. 'HEAD' or 'abc1234'"},
	{label: "Analyze a commit range", description: "Compare two refs, branches, tags, or SHAs.", placeholder: "main HEAD", help: "commit range, e.g. 'main HEAD' or 'main..HEAD'"},
}
...
// PromptAnalysis displays the interactive target selector and returns commit arguments.
